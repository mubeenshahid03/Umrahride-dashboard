...
function Carbookings() {
    ...
    const{isSpin,setisSpin,isAddPkgfair,
        ...
        fetchPkgs,
        fairpkgs,
        setfairpkgs,seteditPkgId}=useContext(carContext)
      ...
      const handledelete=async(pkgid)=>{
        //`http://localhost:7000/api/vehicles/deletepkg/${pkgid}`
          ...
          try{
            ...
            const response = await fetch(`https://umrahride-dashboard-backend.vercel.app/api/vehicles/deletepkg/${pkgid}`, {
                method: "POST", 
                headers: {
        ...
        >
          ...
          (<table class="table">
            <thead className='thead-bg'>
                ...
                <th  className='tables-heading-padding'  scope="col">Car type</th>
                <th   className='tables-heading-padding' scope="col">Description</th>
                ...
                <th className='tables-heading-padding' scope="col">
                  <Button onClick={()=>{setisPkgModelOpen(true);setisAddPkgfair(true)}}  type="primary" style={{height:"25px",width:"80px",padding:"2px",border:"none",margin:"2px",backgroundColor:"#1677ff",color:"white"}}  >
