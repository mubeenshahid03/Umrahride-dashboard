  ...
  const handledelete = async (locationid) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://umrahride-dashboard-backend.vercel.app/api/vehicles/deletelocation/${locationid}`,
        {
          method: "POST",
          headers: {
      ...
      console.log(
        "error in frontend api request to delete location in vehicle.js" + error
      );
    }
  };
