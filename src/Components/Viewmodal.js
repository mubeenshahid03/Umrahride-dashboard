...
function Viewmodal(props) {
    ...
    const{isViewModalOpen,
        setisViewModalOpen,selectedBooking,
        setSelectedBooking,fetchallbookings}=useContext(carContext)
    ...
    const onFinish = async (values) => {
        try {
          const response = await fetch('https://umrahride-dashboard-backend.vercel.app/api/vehicles/editbookingstatus', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
    ...
    <Modal
      ...
      >
        <Form
         ...
         <img width="100%" height="270px"  src={props.booking.vehicle.imgURL} /> 
            </Col>
            </Form.Item>
            <Form.Item>
            ...
            <h6>Cardetails</h6>
            <p>{props.booking.vehicle.name},{props.booking.vehicle.cartype}</p>
  ...
  {props.booking.isPackage
    ...
    : `${props.booking.destination.from} to ${props.booking.destination.to}`}
            ...
            <p>{props.booking.user.name? props.booking.user.name : props.booking.user._id}</p>
            <h6>phone Number</h6>
            ...
            <Form.Item
             ...
             name="bookingstatus"
             rules={[
               { required: true, message: 'Please enter bags' },
      ...
      <Option value="0">Not Approved</Option>
            ...
            <Form.Item>
            <Button id='book-summary-btn' htmlType="submit" style={{backgroundColor:"green",color:"white"}}   >Change</Button>
            <Button id='book-summary-btn' style={{backgroundColor:"red",color:"white"}} onClick={handleCancel}  >Close</Button>
