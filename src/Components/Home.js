...
function Home() {
  ...
  isSpin, setisSpin,
        ...
        fetchsortedbookings,todayBookings,latestBookings,cardData}=useContext(carContext)
  // const cardData = [
...
// }
  ...
  <Row id="dashboard-cards">
    ...
    <div id='hometablea' >
    <div  className='table-responsive' style={{backgroundColor:"white",padding:"30px",borderRadius:"8px"}}>
    <h5 className='mb-4' >PickUps (Today & Tomorrow) </h5>
    {todayBookings?  (<Dashboardtable todayBookings={todayBookings} />) : (<Spinner />)  } 
    </div>
    </div>
    <div id='hometableb'>
    <div className='table-responsive' style={{backgroundColor:"white",padding:"30px",borderRadius:"8px"}}>
