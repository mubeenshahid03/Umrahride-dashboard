...
function Packages() {
  const{isSpin,fetchallpackages,packages,setpackages,setisSpin,currentLocation,setcurrentLocation,isPkgModelOpen,
    setisPkgModelOpen,isAddAdminBtn,setisAddAdminBtn,editPkgId,seteditPkgId,fetchallvehicles}=useContext(carContext)
